<!--每日签到-->
<template>
  <div id="BetBackWater-main">
    <div class="title">投注返水活动</div>
    <div class="content">
  ...
  data() {
    return {
      ...
      tableStyle: [
        ...
        { label: "最低投注流水", prop: "one", width: "" },
        { label: "最高投注流水", prop: "two", width: "" },
        { label: "返水比例", prop: "three", width: "" },
