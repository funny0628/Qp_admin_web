<template>
  <div id="packagemanage">
    <div class="input-area">
      <el-input v-model="user_id" placeholder="请输入包id" size="medium"></el-input>
      <el-input v-model="level" placeholder="标示" size="medium" class="w-160"></el-input>
      <el-input v-model="user_id" placeholder="包状态" size="medium"></el-input>
        ...
        >
          ...
          <p>
            <el-form-item label="绑定用户" prop="user" class="formleft">
              <el-input v-model="ruleForm.user" placeholder="（6-8位数字）"></el-input>
            </el-form-item>
