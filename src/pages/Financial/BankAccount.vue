  ...
  <div id="BankAccount-main">
    ...
    <div class="dialog">
      <el-dialog :title="dialogTitle" :visible.sync='dialogVisible' width='50%'>
        <el-form :v-model="bank_account" style="display: flex; justify-content: space-between;flex-wrap:wrap ;">
          ...
          <el-form-item label="用户分层" :label-width="labelWidth" style="width: 50%;">
            <el-checkbox-group v-model="bank_account.user_layer" @change="handleCheckedCitiesChange">
