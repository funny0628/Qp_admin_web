      ...
      <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="50%">
        ...
        >
          ...
          <el-form-item label="商户密钥" :label-width="labelWidth" style="width: 50%;">
            <el-input v-model="third_account.merchant_key " type="password" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="用户分层" :label-width="labelWidth" style="width: 50%;">
            <el-checkbox-group
              v-model="third_account.user_layer"
          ...
          <el-form-item label="支付公钥" :label-width="labelWidth" style="width: 50%;">
            <el-input v-model="third_account.public_key" type="password" autocomplete="off"></el-input>
          </el-form-item>
