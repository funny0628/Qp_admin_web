  ...
  <div id='ThirdAccount-main'>
    ...
    <div class="dialog">
      <el-dialog :title="dialogTitle" :visible.sync='dialogVisible' width='50%'>
        <el-form :v-model="third_account" style="display: flex; justify-content: space-between;flex-wrap:wrap ;">
          ...
          <el-form-item label="是否启用" :label-width="labelWidth" style="width: 50%;">
            <el-switch v-model="third_account.delivery"></el-switch>
          </el-form-item>
          <el-form-item label="商户号" :label-width="labelWidth" style="width: 50%;">
            <el-input v-model="third_account.merchant" autocomplete="off"></el-input>
          </el-form-item>
          ...
          <el-form-item label="商户密钥" :label-width="labelWidth" style="width: 50%;">
            <el-input v-model="third_account.merchant_key " autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="用户分层" :label-width="labelWidth" style="width: 50%;">
            <el-checkbox-group v-model="third_account.user_layer" @change="handleCheckedCitiesChange">
              <el-checkbox v-for="city in cities" :label="city" :key="city">{{city}}</el-checkbox>
            </el-checkbox-group>
          </el-form-item>
          <el-form-item label="支付公钥" :label-width="labelWidth" style="width: 50%;">
            <el-input v-model="third_account.public_key" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="预设金额" :label-width="labelWidth" style="width: 50%;">
            <el-input v-model="third_account.preset_money" autocomplete="off"></el-input>
            <el-tag
              :key="tag"
              v-for="tag in dynamicTags"
              closable
              :disable-transitions="false"
              @close="handleClose(tag)" style="cursor: pointer;">
              {{tag}}
            </el-tag>
            <el-input
              class="input-new-tag"
          ...
          <el-form-item label="单笔最小额度" :label-width="labelWidth" style="width: 50%;">
            <el-input v-model="third_account.min_account" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="单笔最大额度" :label-width="labelWidth" style="width: 50%;">
            <el-input v-model="third_account.max_account" autocomplete="off"></el-input>
          </el-form-item>
        </el-form>
