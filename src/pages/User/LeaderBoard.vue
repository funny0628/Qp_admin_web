      ...
      <el-dialog
        ...
        <el-form  label-width="120px" :model="formData">
          <el-form-item label="排行榜显示：">
            ...
            <div class="earn" >
              <el-button type="success" style="border-radius: 0;">今日盈利排行</el-button><button class="el-icon-check" style="height: 40px;width: 40px; border-color: #e4e4e4; border: none;"></button></div>
            <div class="result" style="padding-left: 10px;">
              <el-button style="border-radius: 0;">个人业绩排行</el-button><button class="el-icon-check" style="height: 40px;width: 40px; border-color: #e4e4e4; border: none;"></button>
            </div>
            </div>
          </el-form-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        tabIndex: 0,
        /*tb*/
        tableData: [{rank: '1', player_name: '职业玩家', player_id: '10001', earn: '1000000.00', result: '1238.00'}],
        dialogVisible:false,
        formData:{
          region:''
        }
