  ...
  data() {
    ...
    return {
      ...
      tableStyle: [
        ...
        { label: "进入前钱包金币", prop: "before_gold", width: "" },
        { label: "进入的游戏房间", prop: "enter_room", width: "" },
        { label: "进入时间", prop: "enter_time", width: "" },
        { label: "输赢金币", prop: "win_or_lose_gold", width: "" },
        { label: "离开时间", prop: "leave_time", width: "" },
        { label: "离开后钱包金币", prop: "after_gold", width: "" }
      ],
      tableData: [
        {
          "user_id": "1000100",
