...
<template>
  <div id="F_RobotControl">
    <el-button type="primary" @click="submitForm('ruleForm',1)">保存</el-button
    ><el-button type="primary" @click="submitForm('ruleForm',2)">发送到服务器配置</el-button>
    <!-- 头部 -->
    <div class="title">
    ...
    <div class="form">
      ...
      >
        <el-form-item label="机器人总数" prop="count">
          <el-input style="width:200px" v-model="ruleForm.count" placeholder="0"></el-input>
        </el-form-item>


        <el-form-item label="单场机器人的数量及概率" prop="num_rate">
          <el-input style="width:200px" v-model="ruleForm.num_rate" placeholder="0"></el-input>（格式如：3=40,4=40,5=20）
        </el-form-item>
        <el-form-item label="携带范围" prop="coins_range">
          <el-input style="width:200px" v-model="ruleForm.coins_range" placeholder="0"></el-input> (格式如：1,2）
        </el-form-item>
        <el-form-item label="携带金币总额(元)" prop="total_coin">
          <el-input style="width:200px" v-model="ruleForm.total_coin" placeholder="0"></el-input>
        </el-form-item>
        <el-form-item label="离桌率(百分比)" prop="exit_rate">
          <el-input style="width:200px" v-model="ruleForm.exit_rate" placeholder="0"></el-input>
        </el-form-item>
      </el-form>
    </div>
  </div>
