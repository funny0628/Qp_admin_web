<template>
  ...
  >
    <el-button v-has="'ddz_robot_config_save'" type="primary" @click="submitForm('ruleForm', 1)">保存</el-button
    ><el-button v-has="'ddz_robot_config_send'" type="primary" @click="submitForm('ruleForm', 2)"
      >发送到服务器配置</el-button
    >
    <div v-has="'ddz_robot_config_detail'">
    <!-- 头部 -->
    <div class="title">
