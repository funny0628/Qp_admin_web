    ...
    <div class="form">
      ...
      >
        ...
        <el-form-item label="个人区域限红（小奔驰、宝马、大众、保时捷）5倍区域" prop="times_5_limit">
          <el-input style="width:200px" v-model="ruleForm.times_5_limit" placeholder="0"></el-input>
     </el-form-item>

        <el-form-item label="个人区域限红（大大众）10倍区域" prop="times_10_limit">
          <el-input style="width:200px" v-model="ruleForm.times_10_limit" placeholder="0"></el-input>
     </el-form-item>
     
        <el-form-item label="个人区域限红 （大宝马）20倍区域" prop="times_20_limit">
          <el-input style="width:200px" v-model="ruleForm.times_20_limit" placeholder="0"></el-input>
     </el-form-item>
        <el-form-item label="个人区域限红（大奔驰）30倍区域" prop="times_30_limit">
          <el-input style="width:200px" v-model="ruleForm.times_30_limit" placeholder="0"></el-input>
     </el-form-item>
        <el-form-item label="个人区域限红（大保时捷）40倍区域" prop="times_40_limit">
          <el-input style="width:200px" v-model="ruleForm.times_40_limit" placeholder="0"></el-input>
     </el-form-item>
        <el-form-item label="区域总限红（小奔驰、宝马、大众、保时捷）5倍区域" prop="all_times_5_limit">
          <el-input style="width:200px" v-model="ruleForm.all_times_5_limit" placeholder="0"></el-input>
     </el-form-item>
     
        <el-form-item label="区域总限红（大大众）10倍区域" prop="all_times_10_limit">
          <el-input style="width:200px" v-model="ruleForm.all_times_10_limit" placeholder="0"></el-input>
     </el-form-item>
     
        <el-form-item label="区域总限红 （大宝马）20倍区域" prop="all_times_20_limit">
          <el-input style="width:200px" v-model="ruleForm.all_times_20_limit" placeholder="0"></el-input>
     </el-form-item>
     
        <el-form-item label="区域总限红（大奔驰）30倍区域" prop="all_times_30_limit">
          <el-input style="width:200px" v-model="ruleForm.all_times_30_limit" placeholder="0"></el-input>
     </el-form-item>
     
        <el-form-item label="区域总限红（大保时捷）40倍区域" prop="all_times_40_limit">
          <el-input style="width:200px" v-model="ruleForm.all_times_40_limit" placeholder="0"></el-input>
     </el-form-item>
