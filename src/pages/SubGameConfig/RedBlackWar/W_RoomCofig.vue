<template>
  <div id="W_RoomCofig" v-loading="loading"
    ...
    <div v-has="'hhdz_room_config_detail'">
    <!-- 头部 -->
    <div class="title">
    ...
    <div class="form">
      <el-button v-has="'hhdz_room_config_send'" style="margin-bottom:10px" type="primary" @click="submitForm('ruleForm',2)">发送到服务器配置</el-button>
      <el-form
        :model="ruleForm"
        :rules="rules"
        ref="ruleForm"
      ...
      >
        ...
        <el-form-item>
          <el-button v-has="'hhdz_room_config_save'" type="primary" @click="submitForm('ruleForm',1)"
            >立即提交</el-button
          >
        </el-form-item>
      </el-form>
