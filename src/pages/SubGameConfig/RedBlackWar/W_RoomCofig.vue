  ...
  <div id="W_RoomCofig">
    ...
    <div class="form">
      ...
      >
        ...
        <el-form-item label="个人区域限红（红）" prop="name">
          <el-input style="width:200px" v-model="ruleForm.name" placeholder="0"></el-input>
     </el-form-item>

        <el-form-item label="个人区域限红（黑）" prop="name">
          <el-input style="width:200px" v-model="ruleForm.name" placeholder="0"></el-input>
     </el-form-item>
     
        <el-form-item label="个人区域限红（幸运）" prop="name">
          <el-input style="width:200px" v-model="ruleForm.name" placeholder="0"></el-input>
     </el-form-item>
     
        <el-form-item label="红黑区域差额限制" prop="name">
          <el-input style="width:200px" v-model="ruleForm.name" placeholder="0"></el-input>
     </el-form-item>
     
        <el-form-item label="幸运区域总值限制" prop="name">
          <el-input style="width:200px" v-model="ruleForm.name" placeholder="0"></el-input>
     </el-form-item>
