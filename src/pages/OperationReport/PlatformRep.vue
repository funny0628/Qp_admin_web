  ...
  data() {
    ...
    return {
      ...
      tableStyle: [
        ...
        { label: "充值", prop: "nickname", width: "" },
        { label: "兑换", prop: "before_gold", width: "" },
        { label: "税收", prop: "enter_room", width: "" },
        { label: "台费", prop: "enter_time", width: "" },
        { label: "流水", prop: "win_or_lose_gold", width: "" },
        { label: "返水", prop: "leave_time", width: "" },
        { label: "活动赠送", prop: "leave_time", width: "" },
        { label: "代理收益", prop: "leave_time", width: "" },
