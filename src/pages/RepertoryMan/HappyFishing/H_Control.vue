<template>
  <div id="H_Control"   v-loading="loading"
    ...
    <div class="title">
      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="欢乐捕鱼-低倍场" :name="namelist[0]"></el-tab-pane>
        <el-tab-pane label="欢乐捕鱼-中倍场" :name="namelist[1]"></el-tab-pane>
        <el-tab-pane label="欢乐捕鱼-高倍场" :name="namelist[2]"></el-tab-pane>
        <el-tab-pane label="欢乐捕鱼-土豪场" :name="namelist[3]"></el-tab-pane>
      </el-tabs>
    </div>
