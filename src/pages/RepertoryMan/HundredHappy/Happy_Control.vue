<template>
  <div id="Happy_Control"   v-loading="loading"
    ...
    <div class="title">
      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="财神驾到-低倍场" :name="namelist[0]"></el-tab-pane>
        <el-tab-pane label="财神驾到-中倍场" :name="namelist[1]"></el-tab-pane>
        <el-tab-pane label="财神驾到-高倍场" :name="namelist[2]"></el-tab-pane>
        <el-tab-pane label="财神驾到-土豪场" :name="namelist[3]"></el-tab-pane>
      </el-tabs>
    </div>
