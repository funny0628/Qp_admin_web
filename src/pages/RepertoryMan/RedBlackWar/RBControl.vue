<template>
  <div id="RBControl"   v-loading="loading"
    ...
    <div class="title">
      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="红黑-低倍场" :name="namelist[0]"></el-tab-pane>
        <el-tab-pane label="红黑-中倍场" :name="namelist[1]"></el-tab-pane>
        <el-tab-pane label="红黑-高倍场" :name="namelist[2]"></el-tab-pane>
        <el-tab-pane label="红黑-土豪场" :name="namelist[3]"></el-tab-pane>
      </el-tabs>
    </div>
