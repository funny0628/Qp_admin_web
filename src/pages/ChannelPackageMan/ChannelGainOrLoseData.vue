<template>
  <div id="ChannelGainOrLoseData-main">
    <input-area>
      ...
      <el-input v-model="format.channel_id" placeholder="请输入渠道ID" clearable size="medium"></el-input>
      <el-date-picker
  ...
  data() {
    ...
    return {
      ...
      tableStyle: [
        ...
        { label: "渠道玩家人数", prop: "before_gold", width: "" },
        { label: "渠道业绩", prop: "enter_room", width: "" },
        { label: "渠道代理返佣", prop: "enter_time", width: "" },
        { label: "投注金额", prop: "win_or_lose_gold", width: "" },
        { label: "返奖金额", prop: "leave_time", width: "" },
        { label: "税收金额", prop: "leave_time", width: "" },
        { label: "总投注金额", prop: "leave_time", width: "" },
        { label: "总返水金额", prop: "leave_time", width: "" },
        { label: "渠道总盈亏", prop: "leave_time", width: "" },
        { label: "总税收", prop: "leave_time", width: "" },
      ],
      tableData: [
        {
          "user_id": "1000100",
