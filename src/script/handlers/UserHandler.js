...
class UserHandler extends BaseHandler {
  ...
  //用户分层
  vip_list(data,user_id) {
    return this.get_v1("/vip_list/" + user_id, data);
  }

  //添加用户分层
  vip_add(data,user_id) {
    return this.set_v1("/vip_add/" + user_id, data);
  }

  //修改用户分层
  vip_set(data,user_id) {
    return this.set_v1("/vip_set/" + user_id, data);
  }
  //排行榜
